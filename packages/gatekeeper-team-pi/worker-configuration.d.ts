/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d3e0f5c854ccc04e3dda3aa7f326b661)
...
interface __BaseEnv_Env {
	// These values are supplied by deploy-inputs.json rather than checked-in Wrangler vars.
	TEAM_PI_AUTH0_DOMAIN?: string;
	TEAM_PI_AUTH0_CLIENT_ID?: string;
	TEAM_PI_AUTH0_AUDIENCE?: string;
	TEAM_PI_BASE_URL?: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "TeamPiAccount" | "TeamPiGatekeeper";
	}
