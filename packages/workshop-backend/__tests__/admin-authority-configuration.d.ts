/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=__tests__/wrangler.admin-authority.jsonc __tests__/admin-authority-configuration.d.ts` (hash: 81147494cde7c6f00f60726a95dce1ef)
// Runtime types generated with workerd@1.20260801.1 2026-02-02 allow_irrevocable_stub_storage,experimental,nodejs_compat
interface __BaseEnv_Env {
	...
	TEST_ADMIN_PROVIDERS: DurableObjectNamespace<import("./admin-authority-worker").AdminProviderTestHooks>;
	TEST_CONTEXT_COLLECTIONS: DurableObjectNamespace<import("./admin-authority-worker").ContextCollectionDurableObject>;
	TEST_USER_LIBRARIES: DurableObjectNamespace<import("./admin-authority-worker").UserLibraryDurableObject>;
	TEST_LIBRARY_REGISTRIES: DurableObjectNamespace<import("./admin-authority-worker").LibraryRegistryDurableObject>;
	TEST_JARVIS_POLICY: DurableObjectNamespace<import("./admin-authority-worker").JarvisPolicy>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./admin-authority-worker");
		durableNamespaces: "OverseerDurableObject" | "UserDurableObject" | "AdminSettings" | "AdminAuthority" | "AdminProviderTestHooks" | "ContextCollectionDurableObject" | "UserLibraryDurableObject" | "LibraryRegistryDurableObject" | "JarvisPolicy" | "CommunityRequests" | "PendingLogin";
	}
