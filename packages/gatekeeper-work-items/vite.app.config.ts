  ...
  return {
    ...
    closeBundle() {
      ...
      const html = readFileSync(builtHtml, "utf8").replace(
        ...
        "$1$2\n//# sourceURL=app:///gatekeeper/work-items/gatekeeper-work-items.js\n$3",
      );
      const script = html.match(/<script type="module"[^>]*>([\s\S]*?)<\/script>/)?.[1];
      if (script && errorReporting) {
        writeFileSync(
          resolve(packageDirectory, "dist-app", "gatekeeper-work-items.js"),
          `${script}\n//# sourceMappingURL=gatekeeper-work-items.js.map\n`,
        );
      }
      const output = resolve(packageDirectory, "src", "generated", "app.txt");
      const contents =
        "<!-- Generated from packages/gatekeeper-work-items/app by build-app.mjs. Do not edit. -->\n" + html;
  ...
  return {
    ...
    build: {
      ...
      rollupOptions: {
        ...
        output: { entryFileNames: "gatekeeper-work-items.js" },
      },
      watch: watch
